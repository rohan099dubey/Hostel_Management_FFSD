...
function renderResolutionTimeChart(hostel, days) {
    const filteredProblems = filterProblems(hostel, days);
    const { categories, avgTimes } = calculateResolutionTimeByCategory(filteredProblems);
...
function createHostelCharts() {
    ...
    hostels.forEach(hostel => {
        ...
        const resolvedProblems = hostelProblems.filter(p => p.status === "Resolved");
